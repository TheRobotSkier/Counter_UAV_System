...
def get_dataloader(dataset, batch_size, num_workers, shuffle=False, drop_last=False, sampler=None):
    collate = collate_fn
    dataloader = DataLoader(
        ...
        drop_last=drop_last, 
        collate_fn=collate,
        sampler=sampler,           # Added for DDP training
        pin_memory=False,           # enables async H2D copies
