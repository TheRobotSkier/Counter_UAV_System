...
1) Initializes ROS2 and publishes DOA estimates to a ROS2 topic: /acoustics/doa
2) Optionally requests speed of sound from a ROS2 service: /acoustics/speed_of_sound 
...
ROS2 service type: acoustics_msgs/srv/SpeedOfSound
Behavior:
...
def main() -> None:
    ...
    #     - The service is expected to be provided by speed_of_sound_service.py
    ...
    # -------------------------------------------------------------------------
        ...
        # calls.  The service type is acoustics_msgs/srv/SpeedOfSound.
